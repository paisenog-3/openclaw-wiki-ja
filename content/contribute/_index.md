...
投稿時に名前やSNSリンクを設定できます。記事フッターに自動表示されます。

| フィールド | 必須 | 説明 |
|-----------|------|------|
| 投稿者名 | 任意 | 空欄なら「匿名」と表示。ペンネームでもOK |
| SNS / Webサイト | 任意 | XやGitHub、ブログなどのURL。記事にリンク付きで表示されます |

{{< callout type="info" >}}
**読者の方へ**: 記事はすべて投稿者の善意で成り立っています。記事が役に立ったら、投稿者のSNSリンクからぜひフォローや感謝を伝えてあげてください。
{{< /callout >}}
